 ...
 */
public class MSRibbonApacheHttpResponse implements com.netflix.client.http.HttpResponse {

    private HttpResponse httpResponse;
    private URI uri;

    public MSRibbonApacheHttpResponse(final HttpResponse httpResponse, final URI uri) {
